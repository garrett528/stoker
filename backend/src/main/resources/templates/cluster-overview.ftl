...
<div>
    ...
    <div id="topics">
        <div class="header-container" style="margin:0px;">
            <div id="topic-header" style="float:left;">
                <h3>
                    <i class="fa fa-database"></i> Topics&nbsp;&nbsp;&nbsp;
                    <a href="<@spring.url '/acl'/>"><i class="fa fa-lock"></i> ACLs</a>
                </h3>
            </div>
            <div id="new-topic-button-container" style="float:right;">
                <a class="btn btn-outline-light" href="<@spring.url '/topic/create'/>"><i class="fa fa-plus"></i>&nbsp;&nbsp;New Topic</a>
            </div>
            <br style="clear:both;"/>
        </div>
        <table class="table table-bordered" style="margin-top:5px">
    ...
    <div id="connectors">
        <h3><i class="fa fa-flask"></i> Connectors</h3>
        <table class="table table-bordered" style="margin-top:5px">
            <thead>
            <tr>
                <th><i class="fa fa-tag"></i> Name</th>
                <th><i class="fa fa-check-circle-o"></i> Status</th>
            ...
            <#list connectorStatuses as c>
                <tr class="dataRow">
                    <td><a href="<@spring.url '/connect/${c.name}'/>">${c.name}</a></td>
                    <#if c.status == "FAILED">
                        <td class="danger text-danger"><i class="fa fa-warning"></i> ${c.status}</td>
                    <#else>
                        <td class="success text-success"><i class="fa fa-bolt"></i> ${c.status}</td>
                    </#if>
                    <td>
                        <table id="connect-tasks-overview-table" class="table table-bordered table-sm">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>State</th>
